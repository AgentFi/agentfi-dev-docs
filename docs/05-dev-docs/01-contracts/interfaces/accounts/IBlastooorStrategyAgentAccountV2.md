<a href="https://github.com/AgentFi/agentfi-contracts/blob/main/contracts/interfaces/accounts/IBlastooorStrategyAgentAccountV2.sol"><img src="/img/github.svg" alt="Github" width="50px"/> Source</a><br/><br/>
...
```solidity
  function executeByStrategyManager(
    struct IBlastooorStrategyAgentAccountV2.ExecuteByStrategyManagerParam params
...
| Name | Type | Description                                                          |
| :--- | :--- | :------------------------------------------------------------------- |
| `params` | struct IBlastooorStrategyAgentAccountV2.ExecuteByStrategyManagerParam | The call to execute. |
...
```solidity
  function executePayableByStrategyManager(
    struct IBlastooorStrategyAgentAccountV2.ExecutePayableByStrategyManagerParam params
  ) external returns (bytes result)
```
Executes an external call from this account.
Can only be called by an authorized executor or strategy manager.
...
| Name | Type | Description                                                          |
| :--- | :--- | :------------------------------------------------------------------- |
| `params` | struct IBlastooorStrategyAgentAccountV2.ExecutePayableByStrategyManagerParam | The call to execute. |
...
| Name | Type | Description                                                          |
| :--- | :--- | :------------------------------------------------------------------- |
| `params` | struct IBlastooorStrategyAgentAccountV2.ExecuteByStrategyManagerParam[] | The calls to execute. |
...
| Name | Type | Description                                                          |
| :--- | :--- | :------------------------------------------------------------------- |
| `params` | struct IBlastooorStrategyAgentAccountV2.ExecutePayableByStrategyManagerParam[] | The calls to execute. |
